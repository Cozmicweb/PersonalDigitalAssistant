package cozmicweb.pda.datagen.item;
...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        shapeless(RecipeCategory.TOOLS, ModItems.OMINOUS_BATTLE_STANDARD)
        ...
        shapeless(RecipeCategory.TOOLS, ModItems.WARDING_BATTLE_STANDARD)
                .requires(ModItems.EMPTY_BATTLE_STANDARD)
