...
public class ModRarities {
    public static final EnumProxy<Rarity> GRAY = new EnumProxy<>(Rarity.class, -1, "pda:gray", (UnaryOperator<Style>) s -> s.withColor(ChatFormatting.GRAY));
    public static final EnumProxy<Rarity> WHITE = new EnumProxy<>(Rarity.class, -1, "pda:white", (UnaryOperator<Style>) s -> s.withColor(ChatFormatting.WHITE));
